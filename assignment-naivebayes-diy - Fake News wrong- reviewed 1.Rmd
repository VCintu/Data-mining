...
author:
  ...
  - name reviewer here - Veronika Cintulova
...
head(cleanDF)
```
###spotted mistake - missing ".csv" in the end of url
###spotted miskate - "fullDF" instead of "rawDF"
...
```
###spotted mistake - missed clean in "cleanCorpus"
...
```
###Spotted mistake trainFD instead of "trainDF"
...
confusionMatrix(predVec, testDF$type, positive = "spam", dnn = c("Prediction", "True")) # Changed Unreliable to unreliable.
```

reviewer adds suggestions for improving the model
##reviewer spotted the mistakes. Last line of code is not working for me, but unfirtunately, i was not able to correct it or find a solution on google